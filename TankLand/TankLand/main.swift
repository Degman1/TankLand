...
var tanks: [Tank] = []
tanks.append( GameTank(id: "0_GameTank", row: 0, col: 0, energy: Constants.initialTankEnergy, instructions: "") )
tanks.append( GameTank(id: "1_GameTank", row: 0, col: 0, energy: Constants.initialTankEnergy, instructions: "") )
tanks.append( GameTank(id: "2_GameTank", row: 0, col: 0, energy: Constants.initialTankEnergy, instructions: "") )
tanks.append( SampleTank(id: "0_SampleTank", row: 0, col: 0, energy: Constants.initialTankEnergy, instructions: "") )
tanks.append( SampleTank(id: "1_SampleTank", row: 0, col: 0, energy: Constants.initialTankEnergy, instructions: "") )
tanks.append( SampleTank(id: "2_SampleTank", row: 0, col: 0, energy: Constants.initialTankEnergy, instructions: "") )
